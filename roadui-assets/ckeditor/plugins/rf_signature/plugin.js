        ...
        CKEDITOR.dialog.add(pluginName, function (editor) {
            return {
                        ...
                        [
                            {
                                id: pluginName + '_attr',
                                type: 'html',
                                html: '<iframe style="width:100%;height:350px;border:0;" frameborder="0" src="index.html?loadurl=' + encodeURIComponent('/form/plugins/signature.vue?editorname=' + editor.name) + editor.iframeQueryString + '"></iframe>'
                            }
                        ]
                }],
                onShow: function () {
                    if (editor.initFunction_signature) {
                        editor.initFunction_signature(editor.currentSelectEditorElement);
                    }
                ...
                onOk: function () {
                    ...
                    input.setAttribute("value", (json.label || '签章') + (bindField.length === 0 ? "" : "(" + bindField + ")"));
                    ...
                    //input.setAttribute("data-password", json.password || 'false');
                    input.setAttribute("data-buttontype", json.buttonType || '');
                    input.setAttribute("data-sign", json.sign || 'false');
