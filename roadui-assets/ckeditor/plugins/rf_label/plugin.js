        ...
        CKEDITOR.dialog.add(pluginName, function (editor) {
            return {
                        ...
                        [
                            {
                                id: pluginName + '_attr',
                                type: 'html',
                                html: '<iframe style="width:100%;height:400px;border:0;" frameborder="0" src="index.html?loadurl=' + encodeURIComponent('/form/plugins/labels.vue?editorname=' + editor.name) + editor.iframeQueryString + '"></iframe>'
                            }
                        ]
                },],
                onShow: function () {
                ...
                onOk: function () {
                    ...
                    input.setAttribute("value", (json.label || 'Label标签') + (bindField.length === 0 ? "" : "(" + bindField + ")"));
                    ...
                    input.setAttribute("data-style", editor.utils.encodeURI(json.style || ''));
                    input.setAttribute("data-isset", json.isSet);
