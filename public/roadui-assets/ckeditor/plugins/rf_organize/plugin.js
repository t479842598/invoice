        ...
        CKEDITOR.dialog.add(pluginName, function (editor) {
            return {
                        ...
                        [
                            {
                                id: pluginName + '_attr',
                                type: 'html',
                                html: '<iframe style="width:100%;height:480px;border:0;" frameborder="0" src="index.html?loadurl=' + encodeURIComponent('/form/plugins/organize.vue?editorname=' + editor.name) + editor.iframeQueryString + '"></iframe>'
                            }
                        ]
                }],
                onShow: function () {
                ...
                onOk: function () {
                    ...
                    input.setAttribute("value", (json.label || '组织架构') + (bindField.length === 0 ? "" : "(" + bindField + ")"));
                    ...
                    input.setAttribute("data-selecttype", (json.selectType || []).join(','));
                    input.setAttribute("data-selectrange", (json.selectRange || []).join(','));
                    input.setAttribute("data-multiple", json.multiple || 'false');
