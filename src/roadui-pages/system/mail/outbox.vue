    ...
    <div class="roadui_page">
        ...
        <div>
            <el-table :data="tableData"
                ...
                <el-table-column prop="receiveUsers" label="收件人" width="350">
                    <template #default="scope">
...
<script setup>
    ...
    const loadTableData = (isQuery) => {
        ...
        ajax.post('/Mail/GetOutList', qs.stringify(formData.value)).then((res) => {
    ...
    const view = (row) => {
        const item = {
            ...
            url: '/system/mail/view?id=' + row.id + '&source=outbox',
            ico: 'Message',
            openMode: 0,
        };
        index_openmenu(item);
