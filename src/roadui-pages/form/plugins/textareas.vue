            ...
            <table class="roadui_formtable" style="width:98%; margin: 0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="margin-left:12px;"><el-checkbox v-model="setJson.disabled" style="vertical-align:middle">禁用</el-checkbox></span>
                        <span style="margin-left:12px;"><el-checkbox v-model="setJson.readOnly" style="vertical-align:middle">只读</el-checkbox></span>
                        <!--<span style="margin-left:12px;"><el-checkbox v-model="setJson.allowClear" style="vertical-align:middle">可清除</el-checkbox></span>-->
                    </td>
                </tr>
                <tr>
                    <th>最大字符</th>
                    <td>
                        <el-input-number :min="0" v-model="setJson.maxLength" style="width:120px;margin-right:12px;" clearable controls-position="right"></el-input-number>
                        行数
                        <el-input-number :min="0" v-model="setJson.rows" style="width:120px;margin-left:12px;" clearable controls-position="right"></el-input-number>
                    </td>
                </tr>
                <tr>
                    <th>背景文字</th>
                    <td>
                        <el-input v-model="setJson.placeholder" placeholder="placeholder" style="width:98%;" clearable></el-input>
                    </td>
                </tr>
            </table>
        </el-tab-pane>
...
<script setup>
    ...
    const init = (input) => {
        setJson.value = {
            field: '', width: '', defaultValue: '', align: 'left', placeholder: '', disabled: false, allowClear: false
        };
        ...
        if (input) {
            ...
            if (parseInt(input.getAttribute("data-rows"))) {
                setJson.value.rows = parseInt(input.getAttribute("data-rows"));
            }
        ...
        editor.initFunction_textarea = init;
    };
</script>