            ...
            <table class="roadui_formtable" style="width:98%; margin: 0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <el-input v-model="setJson.defaultValue" style="width:313px;" clearable></el-input>
                    </td>
                </tr>
                <tr>
                    <th>样式</th>
                    <td>
                        <el-radio-group v-model="setJson.buttonStyle" clearable>
                            <el-radio label="normal">常规radio</el-radio>
                ...
                <tr>
                    <th>选项来源</th>
                    <td>
                        <el-radio-group v-model="setJson.dataSource" clearable style="vertical-align:middle">
                ...
                <tr v-show="setJson.dataSource=='string'">
                    <th>字符串</th>
                    <td>
                        <el-input type="textarea" :rows="3" v-model="setJson.dataSourceString" placeholder="格式：选项1值,选项1标题;选项2值,选项2标题...（字符串不能有单引号)"></el-input>
                    </td>
                </tr>
                <tr v-show="setJson.dataSource=='sql'">
                    <th>SQL</th>
                    <td>
                        <el-input type="textarea" :rows="3" v-model="setJson.dataSourceSql" placeholder="查询返回两个字段，选项值和选项标题。如果只返回一个字段，则选项值和选项标题一样。"></el-input>
                    </td>
                </tr>
                <tr v-show="setJson.dataSource=='url'">
                    <th>URL</th>
                    <td>
                        <el-input type="textarea" :rows="3" v-model="setJson.dataSourceUrl" placeholder="post一个url地址，地址返回[{value:'值',label:'标题'},...]格式json字符串。"></el-input>
                    </td>
                </tr>
            </table>
        </el-tab-pane>
...
<script setup>
    ...
    const init = (input) => {
        setJson.value = {
            id: '', label: '', field: '', width: '', defaultValue: '', buttonStyle: 'normal', dataSource: ''
            , dataSourceDict: '', dataSourceDictValueField: ''
        ...
        if (input) {
            ...
            setJson.value.buttonStyle = input.getAttribute("data-buttonstyle");
        ...
        editor.initFunction_radio = init;
    };
</script>