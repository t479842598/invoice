                ...
                <table class="roadui_formtable" style="width:98%; margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span style="margin-left:12px;">背景文字<el-input v-model="setJson.placeholder" placeholder="placeholder" style="width:220px;margin-left:12px;" clearable></el-input></span>
                    ...
                    <tr>
                        <th>前缀图标</th>
                        <td>
                            <el-selectico v-model="setJson.prefix" style="width:160px;margin-right:12px;" clearable></el-selectico>
                            后缀图标
                            <el-selectico v-model="setJson.suffix" style="width:160px;margin:0 12px;" clearable></el-selectico>
                            <span style="margin-left:12px;">
                                输入类型
                                <el-radio-group v-model="setJson.inputType" style="margin-left:12px;vertical-align:-2px;">
