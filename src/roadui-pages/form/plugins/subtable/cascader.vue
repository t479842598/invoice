                ...
                <table class="roadui_formtable" style="width:98%; margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span style="margin-right:12px;">背景文字<el-input v-model="setJson.placeholder" placeholder="placeholder" clearable style="width:180px;margin-left:12px;"></el-input></span>
                            <el-checkbox v-model="setJson.allowClear" label="可清空" style="vertical-align: middle;"></el-checkbox>
                            ...
                            <span style="margin-left: 18px;">
                                <span>值类型</span>
                                <el-radio-group v-model="setJson.emitPath" style="margin-left:12px;vertical-align:middle;">
