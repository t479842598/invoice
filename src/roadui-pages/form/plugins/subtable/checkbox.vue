            ...
            <el-tab-pane name="0" :label="attrTitle" style="height:100%">
                <table class="roadui_formtable" style="width:98%; margin: 0 auto;">
                    ...
                    <tr v-show="setJson.dataSource=='string'">
                        <th>字符串</th>
                        <td>
                            <el-input type="textarea" :rows="4" v-model="setJson.dataSourceString" placeholder="格式：选项1值,选项1标题;选项2值,选项2标题...（字符串不能有单引号)"></el-input>
                        </td>
                    </tr>
                    <tr v-show="setJson.dataSource=='sql'">
                        <th>SQL</th>
                        <td>
                            <el-input type="textarea" :rows="4" v-model="setJson.dataSourceSql" placeholder="查询返回两个字段，选项值和选项标题。如果只返回一个字段，则选项值和选项标题一样。"></el-input>
                        </td>
                    </tr>
                    <tr v-show="setJson.dataSource=='url'">
                        <th>URL</th>
                        <td>
                            <el-input type="textarea" :rows="4" v-model="setJson.dataSourceUrl" placeholder="post一个url地址，地址返回[{value:'值',label:'标题'},...]格式json字符串。"></el-input>
                        </td>
                    </tr>
                </table>
            </el-tab-pane>
