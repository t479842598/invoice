<template>
    <div>
        <el-form :model="formData" class="inline" label-width="130px">
            ...
            <el-form-item label="是否推送客户邮箱">
                <el-radio-group v-model="formData.ists">
                    <el-radio v-for="item in istsList" :label="item.value">{{ item.label }}</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item>
...
// 表单行循环
const formItems = [
    { label: '客户编号', model: 'customercode', type: '' },
    { label: '客户名称', model: 'customername', type: '' },
    { label: '纳税人识别号', model: 'Taxno', type: '' },
    { label: '开户行', model: 'BankName', type: '' },
    { label: '银行账号', model: 'Account', type: '' },
    { label: '地址', model: 'Address', type: '' },
    { label: '电话', model: 'Phone', type: '' },
    { label: '邮箱', model: 'Email', type: '' },
]
// 获取页面数据
