    ...
    <div v-loading="loading">
        ...
        <div class="table-container">
            <el-table :data="detailData" v-loading="loading" :stripe="pagers.tableStripe" border
                :highlight-current-row="pagers.tableHighlightCurrentRow" max-height="300"
                style="width: 100%;color: #000" :header-cell-style="headerCellStyle" :default-sort="defaultOrder"
                :row-style="changdetailcolor">
        ...
        <el-dialog v-model="dialogShow" :fullscreen="fullscreen" style="padding-bottom: 10px;position: relative;"
            ...
            <EditTask ref="EditRef" v-model:id="ids" v-model:isnew="isnew" v-model:buyerTaxNo="buyerTaxNo"
                v-model:new="news" v-model:flowtaskid="flowtaskid"></EditTask>
...
const EditTask = defineAsyncComponent(() => import('./HandEdit.vue'))
