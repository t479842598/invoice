<template>
    <div style="padding-bottom: 15px;">
        ...
        <table border="1" cellpadding="1" cellspacing="1"
            ...
            <tbody>
                <tr>
                    <td colspan="8" height="50" style="padding-left: 5px;font-weight: bold;color: #6f4946;">
                ...
                <tr style="height: 100px !important;">
                    <td width="26" class="center vertical-text">购买方信息</td>
                    ...
                    <td width="26" class="center vertical-text">销售方信息</td>
                    <td colspan="3" width="250" style="padding: 15px 10px 0px 10px;">
                        <el-form :model="formData" :rules="rules" ref="ruleFormRef" label-width="110px">
                            <el-form-item label="销售方名称" prop="sellerid">
                                <el-select v-show="!readonly" @change="changeSob" v-model="formData.sellerName"
                                    placeholder="请选择开票单位" style="width: 100%;">
                ...
                <tr>
                    <td width="26" class="center vertical-text">备注</td>
                    <td colspan="7">
                        <el-form :model="formData" :rules="rules" ref="ruleFormRef">
                            <el-form-item style="margin: 0px 0px 0px;height: 50px;" prop="remarks">
                ...
                <tr v-if="!isflow">
                    <td colspan="8" style="padding: 15px 10px 0;">
                        <el-form-item>
        ...
        <el-table class="eltable" :summary-method="getSummaries" show-summary :data="detailData" v-loading="loading"
            :stripe="pager.tableStripe" border :highlight-current-row="pager.tableHighlightCurrentRow" max-height="300"
...
const tableDetails = ref([
    ...
    { prop: 'goodsLineNo', label: '序号', align: 'center', useTemplate: false, show: true, width: '60', },
    ...
    { prop: 'notaxamount', label: '无税金额', show: true, align: 'right', useTemplate: true, width: '120', },
    { prop: 'goodsTotalTax', label: '税额', show: true, useTemplate: false, align: 'center', width: '150' },
    { prop: 'goodsTaxRate', label: '税率', show: true, align: 'center', useTemplate: true, minWidth: '150%' },
