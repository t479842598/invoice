<template>
    <!-- 系统设置 -->
    <div class="system-setting" style="position: relative;">
        <el-tabs tab-position="top" style="height: 70vh;">
            <!-- <el-button type="primary" @click="save">保存</el-button> -->
            <el-tab-pane label="单位信息">
                <el-form ref="topform" :model="formData">
                    <el-form-item label="单位编号">
                        <el-input style="width: 200px" v-model="formData.departcode"></el-input>
                    </el-form-item>
                    <el-form-item label="单位名称">
                        <el-input style="width: 200px" v-model="formData.departname"></el-input>
                    </el-form-item>
                    <el-form-item label="">
                        <el-button type="primary" @click="save">保存</el-button>
                    </el-form-item>
                    ...
                    <div style="width: 100%;text-align: center;">
                        <el-form ref="topform" :model="formData">
                            <el-form-item label="系统名称">
                                <el-input style="width: 200px;" v-model="formData.systemname"></el-input>
                            </el-form-item>
                            <el-form-item label="">
                                <el-button type="primary" @click="save">保存</el-button>
                            </el-form-item>
                                ...
                                <td>
                                    <div style="padding-left: 50px;">
                                        <el-upload :action="config.SERVER_WEBADDRESS + '/Files/SaveFiles'"
                                            :show-file-list="false" with-credentials accept=".jpg,.jpeg,.png,.gif"
                                        ...
                                        <div style="width:210px;height:178px;margin-left: 5px;text-align: center;">
                                            <vueCropper ref="cropper" :img="option.img" :autoCrop="option.autoCrop"
                                                :autoCropWidth="option.autoCropWidth"
                                                :autoCropHeight="option.autoCropHeight" :centerBox="option.centerBox"
            ...
            <el-tab-pane label="邮件模板">
                <el-form ref="topform" :model="formData">
                    <el-form-item label="邮件标题">
                        <el-input style="width: 200px" v-model="formData.emailtitle"></el-input>
                    </el-form-item>
                    <el-form-item label="底部内容">
                        <el-input type="textarea" :rows="6" style="width: 200px" v-model="formData.emailtext">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="">
                        <el-button type="primary" @click="save">保存</el-button>
            ...
            <el-tab-pane label="导入发票">
                <el-form :model="formData" inline>
                    <el-checkbox v-model="formData.不排除负数量项目" label="不排除负数量项目">不排除负数量项目</el-checkbox><br>
                    <el-checkbox v-model="formData.自动截取超长字段" label="自动截取超长字段">自动截取超长字段</el-checkbox><br>
                    <el-checkbox v-model="formData.赠品方式折扣" label="导入折扣">赠品方式折扣</el-checkbox><br>
                    <el-checkbox v-model="formData.汇总折扣行" label="导入折扣">汇总折扣行</el-checkbox><br>
                    ...
                    <div>
                        ...
                        <el-input-number v-model="formData.折扣比例" :min="0" :max="100" :controls="false" size="small"
                    ...
                    <el-checkbox v-model="formData.不显示确认开票对话框" label="不显示确认开票对话框">不显示确认开票对话框</el-checkbox><br>
                    <el-form-item label="">
                        <el-button type="primary" @click="save">保存</el-button>
                    </el-form-item>
                </el-form>
            ...
            <el-tab-pane label="发票明细合并">
                <div>
                    <el-divider content-position="left">发票明细合并规则</el-divider>
                    <el-row>
                        <el-col>
                            <el-form :model="formData" inline>
                                ...
                                <el-checkbox v-model="formData.存货税率相同者合并" label="存货税率相同者合并">存货税率相同者合并</el-checkbox><br>
                                <el-checkbox v-model="formData.存货相同者合并" label="存货相同者合并">存货相同者合并</el-checkbox><br>
                            </el-form>
                        </el-col>
                    </el-row>
                </div>
                <div>
                    <el-divider content-position="left">发票明细合并方式</el-divider>
                    <el-row>
                        <el-col>
                            <el-form :model="formData" inline>
                                <el-checkbox v-model="formData.按价税合计合并" label="按价税合计合并">按价税合计合并（调整金额税额）</el-checkbox><br>
                                <el-checkbox v-model="formData.按金额合并" label="按金额合并">按金额合并（调整税额价税合计）</el-checkbox><br>
                                <el-checkbox v-model="formData.推送客户邮箱" label="推送客户邮箱">推送客户邮箱</el-checkbox><br>
                                <el-checkbox v-model="formData.是否抄送公司邮箱" label="是否抄送公司邮箱">是否抄送公司邮箱</el-checkbox><br>
                            </el-form>
                        </el-col>
                    </el-row>
                </div>
            ...
            <!-- <el-tab-pane label="优惠政策">
                <el-form :model="formData" style="margin-top: 20px;padding: 0 10px;">
                    <el-form-item label="优惠政策类型">
                        <el-select v-model="formData.vatSpecialManagement" style="width: 200px" placeholder="请选择优惠政策类型">
                    ...
                    <el-form-item label="优惠政策税率">
                        <el-select v-model="formData.taxrate" style="width: 200px;" placeholder="请选择优惠政策税率">
            ...
            <el-tab-pane label="发票类型显示设置">
                <el-form :model="formData" style="margin-top: 20px;padding: 0 10px;">
                    <el-form-item>
                        <el-checkbox v-model="formData.是否默认选中购买方" label="是否默认选中购买方">是否默认选中购买方</el-checkbox>
                        <el-checkbox v-model="formData.是否默认选中销售方" label="是否默认选中销售方">是否默认选中销售方</el-checkbox>
                    </el-form-item>
                    <el-form-item>
                        <el-checkbox v-model="formData.是否默认选中购买方地址电话" label="是否默认选中购买方地址电话">是否默认选中购买方地址电话</el-checkbox>
                        <el-checkbox v-model="formData.是否默认选中销售方地址电话" label="是否默认选中销售方地址电话">是否默认选中销售方地址电话</el-checkbox>
                    </el-form-item>
                    <el-form-item label="默认发票类型">
                        <el-select v-model="formData.默认发票类型" style="width: 200px" placeholder="默认发票类型">
...
import { View, Edit, Search, Plus, Refresh, Select } from '@element-plus/icons-vue'
