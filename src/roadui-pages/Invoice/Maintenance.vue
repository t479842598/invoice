<template>
    <div>
        ...
        <div class="table-container">
            ...
            <!--提交窗口-->
            <el-dialog v-model="dialogShow" :title="dialogTitle" align-center destroy-on-close width="650px" draggable
...
const Add = defineAsyncComponent(() => import('./MaintenanceAdd.vue'))
...
// 表格循环列
const tableColumns = [
    { prop: 'accountname', label: '单位名称', width: '220' },
...
const loadTableData = (isQuery) => {
    ...
    ajax.post('/SystemAccount/GetList', qs.stringify(formData.value)).then((res) => {
